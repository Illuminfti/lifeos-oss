...
class Plugin:
    """Telegram capture plugin. Outbound send is out of scope."""

    def __init__(self) -> None:
        self.manifest = ConnectorManifest(
            id="org.lifeos.telegram",
            display_name="Telegram",
            source_classes=['message', 'thread', 'person', 'group', 'attachment'],
            ...
            notes="User-authorized Telegram client for personal history. Not a bot pretending to see private chats.",
        )
    ...
    def _fixture_event(self) -> CaptureEvent:
        ...
        text = "synthetic fixture; not personal data (telegram)"
        return CaptureEvent(
            ...
            metadata={"connector": "telegram", "synthetic": True},
        )
