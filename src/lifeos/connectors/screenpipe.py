...
class Plugin:
    """Screenpipe desktop A/V capture plugin. Outbound send is out of scope."""

    def __init__(self) -> None:
        self.manifest = ConnectorManifest(
            id="org.lifeos.screenpipe",
            display_name="Screenpipe desktop A/V",
            source_classes=['audio', 'video', 'transcript'],
            capabilities=['incremental_sync', 'purge'],
            auth_modes=['local_permission'],
            custody="local",
            outbound_actions=False,
            notes="Screenpipe integration for desktop audio/video. Not a from-scratch recorder.",
        )
    ...
    def _fixture_event(self) -> CaptureEvent:
        ...
        text = "synthetic fixture; not personal data (screenpipe)"
        return CaptureEvent(
            ...
            metadata={"connector": "screenpipe", "synthetic": True},
        )
