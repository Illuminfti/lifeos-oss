...
class Plugin:
    """WhatsApp export import capture plugin. Outbound send is out of scope."""

    def __init__(self) -> None:
        self.manifest = ConnectorManifest(
            id="org.lifeos.whatsapp-export",
            display_name="WhatsApp export import",
            source_classes=['message', 'thread'],
            capabilities=['backfill', 'purge'],
            auth_modes=['file_import'],
            custody="local",
            outbound_actions=False,
            notes="Imports user-generated chat exports. Personal live backfill is not claimed.",
        )
    ...
    def _fixture_event(self) -> CaptureEvent:
        ...
        text = "synthetic fixture; not personal data (whatsapp-export)"
        return CaptureEvent(
            ...
            metadata={"connector": "whatsapp-export", "synthetic": True},
        )
