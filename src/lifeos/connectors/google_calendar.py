...
class Plugin:
    """Google Calendar capture plugin. Outbound send is out of scope."""
    ...
    def __init__(self) -> None:
        self.manifest = ConnectorManifest(
            ...
            notes="Read-only calendar. Writes are out of capture scope.",
        )
    ...
    def _fixture_event(self) -> CaptureEvent:
        ...
        text = "synthetic fixture; not personal data (google-calendar)"
        return CaptureEvent(
            ...
            metadata={"connector": "google-calendar", "synthetic": True},
        )
