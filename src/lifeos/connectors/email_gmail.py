...
class Plugin:
    """Gmail capture plugin. Outbound send is out of scope."""
    ...
    def __init__(self) -> None:
        self.manifest = ConnectorManifest(
            ...
            notes="Read-only Gmail. Outbound send is a separate approval-gated adapter.",
        )
    ...
    def _fixture_event(self) -> CaptureEvent:
        ...
        text = "synthetic fixture; not personal data (email-gmail)"
        return CaptureEvent(
            ...
            metadata={"connector": "email-gmail", "synthetic": True},
        )
